...
const Register = () => {
 return(
    <div className="w-full h-[100vh] flex justify-center items-center bg-purple-900">
      ...
      <div className='text-[55px] font-bold text-white S320:text-[30px] S375:text-[35px]'>Let's Get Started😁
      </div>
      <div className='flex justify-center items-center m-3 text-[20px] text-gray-400 text-center'>
                  Sign up or login to have a full digital experience <br/> on our platform.
                </div>
            ...
            <div className='m-3'>
                ...
                <button type='submit' className='w-full h-[55px] text-[25px] bg-orange-600  mt-6 rounded-3xl  text-white hover:bg-orange-700'>
                 Register
                  ...
                  <Link to={"/signIn"}>
                  <div className='w-[full] h-[55px] text-[25px] bg-slate-100 border text-orange-600  rounded-3xl   hover:bg-slate-300 flex justify-center items-center cursor-pointer'>
                  SignIn
